...
public class WhaleModel extends AgeableListModel<Whale> {
    ...
    public static LayerDefinition getLayerDefinition() {
        ...
        PartDefinition head = partdefinition.addOrReplaceChild(
                ...
                CubeListBuilder.create()
                        .texOffs(0, 0)
                        .addBox(-12.0F, -6.0F, -36.0F, 24.0F, 18.0F, 36.0F)
                        .texOffs(0, 108)
                        .addBox(-12.0F, -6.0F, -15.0F, 24.0F, 18.0F, 0.0F),
        ...
        PartDefinition jaw = head.addOrReplaceChild(
                ...
                CubeListBuilder.create()
                        .texOffs(0, 54)
                        .addBox(-12.0F, -16.0F, -35.0F, 24.0F, 18.0F, 36.0F, new CubeDeformation(0.5F))
                        .texOffs(-13, 108)
                        .addBox(-12.5F, -0.65F, -35.5F, 25.0F, 0.0F, 37.0F),
        ...
        PartDefinition body = head.addOrReplaceChild(
                ...
                CubeListBuilder.create()
                        .texOffs(84, 54)
                        .addBox(-8.0F, -5.0F, 0.0F, 16.0F, 16.0F, 16.0F)
                        .texOffs(0, 0)
        ...
        PartDefinition leftFin = body.addOrReplaceChild(
                ...
                PartPose.offset(8.0F, 7.0F, 4.0F)
        );
    ...
    public void setupAnim(Whale entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        ...
        if (entity.isInWater()) {
            ...
            this.body.xRot = Mth.cos(animationProgress * speed * 0.2F + 1f) * degree * 0.3F * 0.25F;
            ...
            this.tail.xRot = Mth.cos(animationProgress * speed * 0.2F + 0.5f) * degree * 2F * 0.25F;

            this.flukes.xRot = Mth.cos(animationProgress * speed * 0.2F) * degree * 3F * 0.25F;
        }
    }
